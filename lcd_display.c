...
* Modifications made by Kevin J. Conway - kjc@sdlc_by_kjc.mygbiz.com
# Commented out print statements for the PIC and for the menu as well
# as other informational outputs.  this is donwe so that there is no
# extraneous output to the screen that made clutter up a log

# Original code reisdes at https://github.com/ipilcher/n5550/tree/master/lcd in the test2.c file
